...
final class SearchPresentationTests: XCTestCase {
    func testFindPresetPrefersCategoryAndCountryMatches() {
        let filters = MotchillSearchFilterData(
            categories: [MotchillSearchFacetOption(id: 1, name: "Action", slug: "hanh-dong")],
            countries: [MotchillSearchFacetOption(id: 2, name: "Korea", slug: "han-quoc")]
        )
    ...
    private func movie(id: Int, name: String, year: Int) -> MotchillMovieCard {
        MotchillMovieCard(
            id: id,
            name: name,
            otherName: "",
